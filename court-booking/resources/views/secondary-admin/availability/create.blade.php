                ...
                <div class="content-wrapper">
                    ...
                    <div class="col-12 grid-margin">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('secondary-admin.availability.store') }}" method="post">
                                @csrf
                                ...
                                <div class="form-group d-flex justify-content-between">
                                    ...
                                    <a href="{{ route('secondary-admin.availability.index') }}" class="btn btn-outline-danger btn-fw">Cancel</a>
                                </div>
